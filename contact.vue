                ...
                <div class="main_container margin_30 clearfix">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                            <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5b9816d36e6f64281c0a0000/image/jpeg/1539970292397/sidebanner_2 (3).jpg" alt="" />    
                        </div>
        ...
        return Vue.component("contact-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/malvern-contact-us.json"})]);
                        return results;
                    } catch (e) {
