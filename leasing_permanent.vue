                ...
                <div class="main_container mobile_padding margin_30">
                    <div class="details_row">
                        <div class="details_col_3 hidden_phone">
                             <img class="img_max" src="//codecloud.cdn.speedyrails.net/sites/5b9816d36e6f64281c0a0000/image/jpeg/1537546048000/SideBanner6.jpg0" alt="" />    
                        </div>
                        <div class="details_col_9">
                            <h3 class="inside_page_header">Long Term Leasing</h3>
                ...
                validateBeforeSubmitPerm() {
                    this.$validator.validate().then((result) => {
                        ...
                        if (result) {
                            ...
                            perm_formdata.send_to = "huntleyj@davpart.com@davpart.com";
